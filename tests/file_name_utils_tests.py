...
class ClipFileNameUtilsTests(unittest.TestCase):
    ...
    def test_parse_clip_file_name(self):
        ...
        function = file_name_utils.parse_clip_file_name
    ...
    def _assert_result(self, result, expected_result):
        ...
        check(result.detector_name, detector_name)
    ...
    def test_parse_clip_file_name_errors(self):
        ...
        cases = [
            ...
            # bad detector
            'Bobo_2012-01-02_12.34.56_07.wav',
               
            # year out of range
            'Tseep_1899-01-02_12.34.56_07.wav',
            'Tseep_{:d}-01-02_12.34.56_07.wav'.format(next_year),
