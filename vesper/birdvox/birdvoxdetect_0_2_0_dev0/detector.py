...
# Uncomment this to use the BirdVoxDetect 0.2.0.dev0 that is included in the
# `vesper` package of the current Python environment.
import vesper.birdvox.birdvoxdetect_0_2_0_dev0.birdvoxdetect as birdvoxdetect
    ...
    def _process_timestamps(self, timestamp_file_path):
        ...
        with open(timestamp_file_path) as timestamp_file:
            ...
            for row in reader:
                ...
                peak_time = self._parse_timestamp(row[0])
...
class DetectorAT05(_Detector):
    ...
    """BirdVoxDetect with an adaptive threshold whose nominal value is 05."""
    
    extension_name = 'BirdVoxDetect 0.2.0.dev0 AT 05'
...
class DetectorAT10(_Detector):
    ...
    extension_name = 'BirdVoxDetect 0.2.0.dev0 AT 10'
    _settings = _create_at_settings(10)
...
class DetectorAT20(_Detector):
    ...
    extension_name = 'BirdVoxDetect 0.2.0.dev0 AT 20'
    _settings = _create_at_settings(20)
...
class DetectorAT30(_Detector):
    ...
    extension_name = 'BirdVoxDetect 0.2.0.dev0 AT 30'
    _settings = _create_at_settings(30)
...
class DetectorAT40(_Detector):
    ...
    extension_name = 'BirdVoxDetect 0.2.0.dev0 AT 40'
    _settings = _create_at_settings(40)
...
class DetectorAT50(_Detector):
    ...
    extension_name = 'BirdVoxDetect 0.2.0.dev0 AT 50'
    _settings = _create_at_settings(50)
...
class DetectorAT60(_Detector):
    ...
    extension_name = 'BirdVoxDetect 0.2.0.dev0 AT 60'
    _settings = _create_at_settings(60)
...
class DetectorAT70(_Detector):
    ...
    extension_name = 'BirdVoxDetect 0.2.0.dev0 AT 70'
    _settings = _create_at_settings(70)
