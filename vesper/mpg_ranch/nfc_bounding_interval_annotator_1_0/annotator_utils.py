...
_EVALUATION_PLOT_FILE_NAME_FORMAT = '{}_{:02d}.pdf'
...
def create_training_name(settings):
    ...
    return f'{clip_type}_{bound_type}_{start_time}'
...
def get_evaluation_plot_file_path(training_name, epoch_num):
    model_dir_path = get_epoch_model_dir_path(training_name, epoch_num)
    file_name = _EVALUATION_PLOT_FILE_NAME_FORMAT.format(
