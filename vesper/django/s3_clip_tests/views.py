...
_env = Env()
_AWS_ACCESS_KEY_ID = _env('VESPER_AWS_ACCESS_KEY_ID')
_AWS_SECRET_ACCESS_KEY = _env('VESPER_AWS_SECRET_ACCESS_KEY')
_AWS_REGION_NAME = _env('VESPER_AWS_REGION_NAME')
_AWS_S3_CLIP_BUCKET_NAME = _env('VESPER_AWS_S3_CLIP_BUCKET_NAME')
