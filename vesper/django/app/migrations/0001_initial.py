# -*- coding: utf-8 -*-
# Generated by Django 1.10.1 on 2017-03-08 17:52
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='AnnotationValueConstraint',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('name', models.CharField(max_length=255, unique=True)),
                ('description', models.TextField(blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('creation_time', models.DateTimeField(null=True)),
                ('annotation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vesper.Annotation')),
                ('clip', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vesper.Clip')),
                ('creating_job', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='string_annotation_values', to='vesper.Job')),
                ('creating_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='string_annotation_values', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.CreateModel(
            name='StringAnnotationValueHistory',
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('value', models.CharField(max_length=255)),
                ('creation_time', models.DateTimeField(null=True)),
                ('annotation', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vesper.Annotation')),
                ('clip', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='vesper.Clip')),
                ('creating_job', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='string_annotation_value_histories', to='vesper.Job')),
                ('creating_user', models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='string_annotation_value_histories', to=settings.AUTH_USER_MODEL)),
            ],
            options={
        ...
        migrations.AddField(
            model_name='annotationvalueconstraint',
            name='creating_job',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='annotation_value_constraints', to='vesper.Job'),
        ),
        migrations.AddField(
            model_name='annotationvalueconstraint',
            name='creating_user',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.CASCADE, related_name='annotation_value_constraints', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='annotation',
            name='constraint',
            field=models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='annotations', to='vesper.AnnotationValueConstraint'),
        ),
        migrations.AddField(
            model_name='annotation',
            name='creating_job',
        ...
        migrations.AlterUniqueTogether(
            name='stringannotationvalue',
            unique_together=set([('clip', 'annotation')]),
        ),
        migrations.AlterUniqueTogether(
            name='stationdevice',
        ...
        migrations.AlterUniqueTogether(
            name='devicemodeloutput',
            unique_together=set([('model', 'channel_num'), ('model', 'local_name')]),
        ),
        migrations.AlterUniqueTogether(
            name='devicemodelinput',
            unique_together=set([('model', 'channel_num'), ('model', 'local_name')]),
