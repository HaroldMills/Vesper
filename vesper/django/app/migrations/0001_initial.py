# -*- coding: utf-8 -*-
# Generated by Django 1.10.5 on 2017-03-16 14:34
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True)),
                ('algorithm', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='versions', related_query_name='version', to='vesper.Algorithm')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True)),
                ('algorithm_version', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='processors', related_query_name='processor', to='vesper.AlgorithmVersion')),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='recordings', related_query_name='recording', to='vesper.StationDevice'),
        ),
        migrations.AddField(
            model_name='job',
            name='processor',
        ...
        migrations.AddField(
            model_name='clip',
            name='recording',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='clips', related_query_name='clip', to='vesper.Recording'),
        ),
        migrations.AddField(
