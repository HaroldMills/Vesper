...
if not settings.ARCHIVE_READ_ONLY:
    ...
    urlpatterns += [
        ...
        path('export-clip-counts-to-csv-file/',
             views.export_clip_counts_to_csv_file,
             name='export-clip-counts-to-csv-file'),
        path('export-clip-tag-counts-to-csv-file/',
             views.export_clip_tag_counts_to_csv_file,
