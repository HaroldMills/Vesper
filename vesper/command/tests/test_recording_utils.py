...
class RecordingUtilsTests(TestCase):
    ...
    def test_group_recording_files(self):
        ...
        cases = [
            ...
            # single file
            ([f('A', 'R', '2015-05-30 20:00:00', '10:00:00')],
             [(f('A', 'R', '2015-05-30 20:00:00', '10:00:00'), 1)]),
                  
            # two exactly consecutive files
            ([f('A', 'R', '2015-05-30 20:00:00', '05:00:00'),
              f('A', 'R', '2015-05-31 01:00:00', '06:00:00')],
             [(f('A', 'R', '2015-05-30 20:00:00', '11:00:00'), 2)]),
                  
            # three exactly consecutive files
            ([f('A', 'R', '2015-05-30 20:00:00', '01:00:00'),
              f('A', 'R', '2015-05-30 21:00:00', '02:00:00'),
              f('A', 'R', '2015-05-30 23:00:00', '03:00:00')],
             [(f('A', 'R', '2015-05-30 20:00:00', '06:00:00'), 3)]),
                  
            # two barely consecutive files, assuming a grouping tolerance
            # of one second per hour
            ([f('A', 'R', '2015-05-30 20:00:00', '05:00:00'),
              f('A', 'R', '2015-05-31 01:00:05', '06:00:00')],
             [(f('A', 'R', '2015-05-30 20:00:00', '11:00:00'), 2)]),
                  
            # two barely non-consecutive files, assuming a grouping tolerance
            # of one second per hour
            ([f('A', 'R', '2015-05-30 20:00:00', '05:00:00'),
              f('A', 'R', '2015-05-31 01:00:06', '06:00:00')],
             [(f('A', 'R', '2015-05-30 20:00:00', '05:00:00'), 1),
              (f('A', 'R', '2015-05-31 01:00:06', '06:00:00'), 1)]),
                 
            # two consecutive short files with a one-second error in
            # the second file's start time
            ([f('A', 'R', '2015-05-30 20:00:00', '00:01:00'),
              f('A', 'R', '2015-05-30 20:00:59', '00:01:00')],
             [(f('A', 'R', '2015-05-30 20:00:00', '00:02:00'), 2)]),
            
            # two non-consecutive files with a two-second error in the
            # second file's start time
            ([f('A', 'R', '2015-05-30 20:00:00', '00:01:00'),
              f('A', 'R', '2015-05-30 20:01:02', '00:01:00')],
             [(f('A', 'R', '2015-05-30 20:00:00', '00:01:00'), 1),
              (f('A', 'R', '2015-05-30 20:01:02', '00:01:00'), 1)]),
                 
            # four consecutive files from two stations
            ([f('A', 'R', '2015-05-30 20:00:00', '01:00:00'),
              f('A', 'R', '2015-05-30 21:00:00', '02:00:00'),
              f('B', 'S', '2015-05-30 23:00:00', '03:00:00'),
              f('B', 'S', '2015-05-31 02:00:00', '04:00:00')],
             [(f('A', 'R', '2015-05-30 20:00:00', '03:00:00'), 2),
              (f('B', 'S', '2015-05-30 23:00:00', '07:00:00'), 2)]),
                 
            # four consecutive files from two recorders
            ([f('A', 'R', '2015-05-30 20:00:00', '01:00:00'),
              f('A', 'R', '2015-05-30 21:00:00', '02:00:00'),
              f('A', 'S', '2015-05-30 23:00:00', '03:00:00'),
              f('A', 'S', '2015-05-31 02:00:00', '04:00:00')],
             [(f('A', 'R', '2015-05-30 20:00:00', '03:00:00'), 2),
              (f('A', 'S', '2015-05-30 23:00:00', '07:00:00'), 2)]),
                 
            # two consecutive files with different numbers of channels
            ([f('A', 'R', '2015-05-30 20:00:00', '05:00:00', 1),
              f('A', 'R', '2015-05-31 01:00:00', '06:00:00', 2)],
             [(f('A', 'R', '2015-05-30 20:00:00', '05:00:00', 1), 1),
              (f('A', 'R', '2015-05-31 01:00:00', '06:00:00', 2), 1)]),
                 
            # two consecutive files with different sample rates
            ([f('A', 'R', '2015-05-30 20:00:00', '05:00:00', 1, 22050),
              f('A', 'R', '2015-05-31 01:00:00', '06:00:00', 1, 24000)],
             [(f('A', 'R', '2015-05-30 20:00:00', '05:00:00', 1, 22050), 1),
              (f('A', 'R', '2015-05-31 01:00:00', '06:00:00', 1, 24000), 1)]),
